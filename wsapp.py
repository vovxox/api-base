...
from app.ws.chebi_workflow import (
    SplitMaf,
    ChEBIPipeLine,
    ChEBIPipeLineLoad,
    CheckCompounds,
...
def initialize_app(flask_app):
    ...
    CORS(
        application,
        resources={application.config.get("CORS_RESOURCES_PATH")},
    ...
    api.add_resource(
        ExtractMSSpectra, res_path + "/ebi-internal/<string:study_id>/extract-peak-list"
    )
